...
// functions defined by Peng Gao
double fpr(const dvec_t& dec_values, const ivec_t& ty);
double fnr(const dvec_t& dec_values, const ivec_t& ty);

// evaluation function pointer
// You can assign this pointer to any above prototype
double (*validation_function)(const dvec_t&, const ivec_t&) = ap; // we use average precision
...
double fnr(const dvec_t& dec_values, const ivec_t& ty){
	...
	return fnr; // return the evaluation value
}
