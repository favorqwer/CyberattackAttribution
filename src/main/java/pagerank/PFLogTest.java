...
/**
 * Created by fang on 11/6/18.
 */
public class PFLogTest {
    public static void main(String[] args){
        ...
        String[] lowRP = {};//"/media/lcl/LCL/bad.zip"};//"192.168.29.125:10289->192.168.29.234:22"}
...
//        String[] lowRP = {"192.168.29.223:58853->192.168.29.234:22"};//"/media/lcl/LCL/bad.zip"};//"192.168.29.125:10289->192.168.29.234:22"}
        ...
        //process(resultDir, suffix, threshold, trackOrigin, path,localIP,detection,highRP,midRP,lowRP, paths[paths.length-1].split("\\.")[0], 15756);
    }
...
//            }
            ...
            for(EventEdge edge:infer.graph.edgeSet()){
